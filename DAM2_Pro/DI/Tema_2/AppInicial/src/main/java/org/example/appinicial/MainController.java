...
public class MainController implements Initializable {
    ...
    @FXML
    private Button buttonPulsar, buttonVaciar, butonLimpiar;
    ...
    private void acciones() {
        ...
        butonLimpiar.addEventHandler(ActionEvent.ACTION, new ManejoAccion());
    ...
    class ManejoAccion implements EventHandler<ActionEvent> {
        ...
        public void handle(ActionEvent actionEvent) {
            ...
            if (actionEvent.getSource() == buttonPulsar) {
                ...
                labelSaludo.setText("");
                textfieldNombre.clear();
            } else if (actionEvent.getSource() == butonLimpiar) {
                textfieldNombre.clear();
            }
        }
    }
